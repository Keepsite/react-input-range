...
function Label(props) {
  ...
  return _react2.default.createElement(
    'span',
    { style: props.style, className: props.classNames[props.type + 'Label'] },
...
var InputRange = (_class = function (_React$Component) {
  ...
  _createClass(InputRange, null, [{
    ...
    get: function get() {
      return {
        ...
        suggestedValue: _valuePropType2.default,
        withActive: _propTypes2.default.bool,
        singleValueError: _propTypes2.default.number
      };
    }
  ...
  _createClass(InputRange, [{
    ...
    key: 'isSuggestedMulti',
    value: function isSuggestedMulti() {
      return this.hasSuggested() && (0, _utils.isObject)(this.props.suggestedValue);
    }
  }, {
    key: 'hasSuggested',
    value: function hasSuggested() {
      return (0, _utils.isObject)(this.props.suggestedValue) || this.props.suggestedValue;
    }
  }, {
    key: 'hasSingleValueError',
    value: function hasSingleValueError() {
    ...
    value: function render() {
      ...
      var values = valueTransformer.getValueFromProps(this.props, this.isMultiValue());
      var percentages = valueTransformer.getPercentagesFromValues(values, this.props.minValue, this.props.maxValue);
      var suggestedValues = valueTransformer.getSuggestedValueFromProps(this.props, this.isSuggestedMulti());
      var suggestedPercentages = valueTransformer.getPercentagesFromValues(suggestedValues, this.props.minValue, this.props.maxValue);
      var midValue = (this.props.minValue + this.props.maxValue) / 2;
      var errorPercentages = { min: null, max: null };
      var errorLabels = [];
      if (this.props.singleValueError > 0) {
        var min = this.props.value - this.props.singleValueError;
        var max = this.props.value + this.props.singleValueError;
        ...
        var errorMinLabel = _react2.default.createElement(
          _label2.default,
          {
        ...
        var errorMaxLabel = _react2.default.createElement(
          _label2.default,
          {
            classNames: this.props.classNames,
            formatLabel: this.props.formatLabel,
...
var Track = (_class = function (_React$Component) {
  ...
  _createClass(Track, null, [{
    ...
    get: function get() {
      return {
        ...
        withActive: _propTypes2.default.bool,
        suggestedPercentages: _propTypes2.default.objectOf(_propTypes2.default.number),
        isMultiValue: _propTypes2.default.bool,
        withError: _propTypes2.default.bool,
        errorPercentages: _propTypes2.default.objectOf(_propTypes2.default.number)
      };
    }
  ...
  _createClass(Track, [{
    ...
    key: 'getSuggestedTrackStyle',
    value: function getSuggestedTrackStyle() {
      var width = (this.props.suggestedPercentages.max - this.props.suggestedPercentages.min) * 100 + '%';
      var left = this.props.suggestedPercentages.min * 100 + '%';

      return { left: left, width: width };
    }
  }, {
    key: 'getActiveTrackStyleWithError',
    value: function getActiveTrackStyleWithError() {
      var width = (this.props.errorPercentages.max - this.props.errorPercentages.min) * 100 + '%';
      var left = this.props.errorPercentages.min * 100 + '%';
    ...
    value: function render() {
      ...
      if (this.props.withActive && !this.props.isMultiValue && this.props.withError) {
        var activeTrackStyle = this.getActiveTrackStyleWithError();
        activeTrack = _react2.default.createElement('div', { style: activeTrackStyle, className: this.props.classNames.activeTrack });
      } else if (this.props.withActive) {
        var _activeTrackStyle = this.getActiveTrackStyle();
        activeTrack = _react2.default.createElement('div', { style: _activeTrackStyle, className: this.props.classNames.activeTrack });
      }

      var suggestedTrack = void 0;
      if (this.props.suggestedPercentages.max !== 0) {
        var suggestedTrackStyle = this.getSuggestedTrackStyle();
        if (!this.props.isMultiValue && !this.props.withError) {
          suggestedTrackStyle.transform = 'translateX(50%)';
        }
        suggestedTrack = _react2.default.createElement('div', { style: suggestedTrackStyle, className: this.props.classNames.suggestedTrack });
      }
...
exports.getSuggestedValueFromProps = getSuggestedValueFromProps;
exports.getValueErrorFromProps = getValueErrorFromProps;
...
function getSuggestedValueFromProps(props, isMultiValue) {
  if (isMultiValue) {
    return _extends({}, props.suggestedValue);
  }
...
function getValueErrorFromProps(props, isMultiValue) {
  if (isMultiValue) {
    return _extends({}, props.value);
  }
